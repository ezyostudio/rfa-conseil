<template>
  <div class="container card p-3 p-md-5 pt-md-4">
     <div class="text-primary d-flex flex-column flex-lg-row justify-content-around align-items-center w-100 m-auto mb-3 mb-md-4 ">
       <div class="d-flex align-items-center m-auto m-lg-0">
         ...
         <div class="d-flex align-items-center">
          ...
          <h6 class="mb-0 one-line"> 06 32 77 41 51 — 09 51 74 07 79</h6>
        </div>
